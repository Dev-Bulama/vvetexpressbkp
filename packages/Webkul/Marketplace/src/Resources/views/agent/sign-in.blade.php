...
<head>
    ...
    <style>
        body { font-family: system-ui, sans-serif; background: #F7FAF9; margin: 0; padding: 40px 16px; }
        .card { max-width: 400px; margin: 0 auto; background: #fff; border-radius: 12px; padding: 32px; box-shadow: 0 1px 3px rgba(0,0,0,.1); }
        h1 { font-size: 22px; margin: 0 0 24px; color: #11455B; }
        label { display: block; font-size: 13px; font-weight: 600; margin: 16px 0 4px; color: #11455B; }
...
<body>
    <div class="card">
        ...
        <form method="POST" action="{{ route('marketplace.agent.session.create') }}">
            @csrf
