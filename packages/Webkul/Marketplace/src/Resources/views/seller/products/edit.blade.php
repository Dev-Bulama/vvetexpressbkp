@include('marketplace::seller.partials.shell-start', ['title' => 'Edit Offer', 'heading' => 'Edit Offer', 'active' => 'products'])

<style>
    .card { max-width: 420px; background: #fff; border-radius: 12px; padding: 32px; box-shadow: 0 1px 3px rgba(0,0,0,.1); }
