                            ...
                            <template v-for="(option, index) in attribute.options">
                                <template v-if="option.id">
                                    ...
                                    <label 
                                        ...
                                        :class="{'border-brandGreen ring-1 ring-brandGreen' : option.id == attribute.selectedValue }"
                                        :title="option.label"
                                    ...
                                    <label 
                                        ...
                                        :class="{'!border-brandGreen !bg-brandGreen/10 !text-brandNavy font-semibold' : option.id == attribute.selectedValue }"
                                        :title="option.label"
